...
function App() {
  ...
  const [currentMusicalDetails, setCurrentMusicDetails] = useState({
    songName: 'Chasing',
    songArtist: 'NEFFEX',
  ...
  const handleMusicProgressBar = (e) => {
    ...
    currentAudio.current.currenTime = e.target.value * currentAudio.current.duration / 100;
  }
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="music-Container">
        ...
        <p className='music-Head-Name'>{currentMusicalDetails.songName}</p>
        <p className='music-Artist-Name'>{currentMusicalDetails.songArtist}</p>
        <img src={currentMusicalDetails.songAvatar} className={avatarClass[avatarClassIndex]} onClick={handleAvatar} alt="song Avatar" id='songAvatar'/>
        ...
        <div className="musicControlers">
          ...
          <i className={`fa-solid ${isAudioPlaying? 'fa-pause-circle' : 'fa-circle-play'} playBtn`} onClick={handlAudioPlay}></i>
